...
auto construct_Array(T& cls)
{
    ...
    cls.def(
        "setElastic",
        static_cast<void (S::*)(
            const xt::pytensor<double, S::rank>&, const xt::pytensor<double, S::rank>&)>(
    ...
    cls.def(
        "reset_epsy",
        static_cast<void (S::*)(
            const xt::pytensor<bool, S::rank>&, const xt::pytensor<double, 1>&, bool)>(
            &S::template reset_epsy),
        "Reset yield strains.",
        py::arg("I"),
        py::arg("epsy"),
        py::arg("init_elastic") = true);
    ...
    cls.def("CurrentIndex", &S::CurrentIndex, "Get potential indices.");
    ...
    cls.def(
        ...
        "Get equivalent plastic strains for all points.");
    ...
    cls.def(
        ...
        "Get energies for all points in the array.");
...
{
    // Ensure members to display as `GMatElastoPlasticQPot.X`
    // (not `GMatElastoPlasticQPot._GMatElastoPlasticQPot.X`)
    ...
    m.def("version", &GMatElastoPlasticQPot::version, "Return version string.");
...

    {
        ...
        cls.def(py::init<double, double>(), "Elastic material point.", py::arg("K"), py::arg("G"));
...

    {
        ...
        cls.def(
            "reset_epsy",
            &SM::Cusp::reset_epsy<xt::pytensor<double, 1>>,
            "Reset yield strains.",
            py::arg("epsy"),
            py::arg("init_elastic") = true);
        ...
        cls.def("epsy", &SM::Cusp::epsy, "Returns the yield strains.");
        ...
        cls.def("Strain", &SM::Cusp::Strain, "Returns strain tensor.");
        ...
        cls.def("Stress", &SM::Cusp::Stress, "Returns stress tensor.");
        ...
        cls.def("Tangent", &SM::Cusp::Tangent, "Returns tangent stiffness.");
        ...
        cls.def("epsp", &SM::Cusp::epsp, "Returns equivalent plastic strain.");

        cls.def("energy", &SM::Cusp::energy, "Returns the energy, for last known strain.");

        cls.def(
            "__repr__", [](const SM::Cusp&) { return "<GMatElastoPlasticQPot.Cartesian2d.Cusp>"; });
    }
...

    {
        ...
        cls.def(
            "reset_epsy",
            &SM::Smooth::reset_epsy<xt::pytensor<double, 1>>,
            "Reset yield strains.",
            py::arg("epsy"),
            py::arg("init_elastic") = true);

        cls.def("K", &SM::Smooth::K, "Returns the bulk modulus.");

        cls.def("G", &SM::Smooth::G, "Returns the shear modulus.");

        cls.def("epsy", &SM::Smooth::epsy, "Returns the yield strains.");
        ...
        cls.def("Strain", &SM::Smooth::Strain, "Returns strain tensor.");
        ...
        cls.def("Stress", &SM::Smooth::Stress, "Returns stress tensor.");
        ...
        cls.def("Tangent", &SM::Smooth::Tangent, "Returns tangent stiffness.");
        ...
        cls.def("epsp", &SM::Smooth::epsp, "Returns equivalent plastic strain.");

        cls.def("energy", &SM::Smooth::energy, "Returns the energy, for last known strain.");
